...
static DIALOG alert_dlg[] = {
  { CTL_WINDOW, window_proc,  0, 0, 400, 180, 0, 7, 0, 0, 0, "Alert" },
  ...
  { CTL_BUTTON, button_proc, 90,  140, 100, 30, 0, 7, D_EXIT, 0, 0, NULL },
  { CTL_BUTTON, button_proc, 210, 140, 100, 30, 0, 7, D_EXIT, 0, 0, NULL },
  { CTL_NONE, NULL }
};
 ...
 */
int alert(WINDOW *parent, char *s1, char *s2, char *s3, char *b1, char *b2)
{
  int ret;
